...
static int _parse_channel(int* argc, char** arg, powermon_config_t* cfg)
{
...
static int _parse_num(int* argc, char** arg, powermon_config_t* cfg)
{
    assert(argc && *argc); assert(arg && *arg); assert(cfg);
    assert(!strcmp(*arg, "-n"));
    DEBUG("%s: argc: %d\n", "_parse_num", *argc);
...
static int _parse_sadc(int* argc, char** arg, powermon_config_t* cfg)
{
    assert(argc && *argc); assert(arg && *arg); assert(cfg);
    assert(!strcmp(*arg, "-s"));
    DEBUG("%s: argc: %d\n", "_parse_sadc", *argc);
...
static int _parse_badc(int* argc, char** arg, powermon_config_t* cfg)
{
    assert(argc && *argc); assert(arg && *arg); assert(cfg);
    assert(!strcmp(*arg, "-b"));
    DEBUG("%s: argc: %d\n", "_parse_badc", *argc);
...
static int _parse_mode(int* argc, char** arg, powermon_config_t* cfg)
{
    assert(argc && *argc); assert(arg && *arg); assert(cfg);
    assert(!strcmp(*arg, "-m"));
    DEBUG("%s: argc: %d\n", "_parse_mode", *argc);
